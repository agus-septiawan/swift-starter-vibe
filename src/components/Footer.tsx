...
const Footer = () => {
  ...
  return (
    <footer className="bg-sketch text-cream py-12 relative">
      ...
      >
        <path
          d="M0,15 Q300,8 600,12 T1200,10"
          stroke="#8B4513"
          strokeWidth="2"
          fill="none"
          strokeLinecap="round"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-8 relative">
            <h3 className="font-handwrite text-4xl text-warm font-bold mb-4 cursor-default relative">
              ...
              {/* Smiley face doodle */}
              <Smile
                className="absolute -top-6 -right-12 text-warm opacity-50"
                size={24}
              />
            </h3>
            ...
            <p className="font-sketch text-cream/60 max-w-2xl mx-auto relative">
              "Creating beautiful digital experiences, one line of code at a
              time."
              {/* Small stars around quote */}
              <svg
                className="absolute -left-4 -top-2 w-3 h-3 text-warm opacity-40"
                viewBox="0 0 20 20"
              >
                <path
              ...
              <svg
                className="absolute -right-4 -bottom-2 w-3 h-3 text-warm opacity-30"
                viewBox="0 0 20 20"
              >
                <path
                  d="M10,2 L12,8 L18,8 L13,12 L15,18 L10,14 L5,18 L7,12 L2,8 L8,8 Z"
          ...
          <div className="flex justify-center gap-6 mb-8">
            {socialLinks.map((social, index) => (
              ...
              >
                <social.icon size={24} className="text-cream" />
          ...
          <div className="font-sans text-cream/60 text-sm relative">
            <p className="flex items-center justify-center gap-2 flex-wrap">
              ...
              {/* Coffee cup doodle */}
              <svg
                className="ml-2 w-4 h-4 text-warm opacity-50"
                viewBox="0 0 20 20"
              >
                <path
                  d="M3,8 L3,14 Q3,16 5,16 L13,16 Q15,16 15,14 L15,8 M16,10 Q18,10 18,12 Q18,14 16,14"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  fill="none"
                />
                <path
                  d="M6,4 L6,6 M9,4 L9,6 M12,4 L12,6"
                  stroke="currentColor"
                  strokeWidth="1"
                  strokeLinecap="round"
                />
